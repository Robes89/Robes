...
*/
*-----------------------------------------------*
User Function V5FAT010(lV5FAT, lVisua, _lCapa, _oCapa, _lWs)
	*-----------------------------------------------*
	Local lExec         := .T.

	Local cModelo := "\templates_relatorios\V5FAT010.dot"
	Local cFileDot := "V5FAT010.dot"
	Local lContinua := .T.
...
// CUSTOMIZADO, B. VINICIUS 31/01/2020
