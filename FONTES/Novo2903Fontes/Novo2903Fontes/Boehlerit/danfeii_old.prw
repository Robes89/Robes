...
#DEFINE MAXVALORC  010	  ///009		// Máximo de caracteres por linha de valores numéricos
#DEFINE MAXCODPRD  080	  ///050    	// Máximo de caracteres do codigo de produtos/servicos conforme o tamanho do quadro "Cod. prod"
...
If lMensagens
	...
	If lMv_Logod
		oDanfe:SayBitmap(000,001,cLogoD,090,090)
	Else
		oDanfe:SayBitmap(000,001,cLogo,090,090)
	EndIf
...
Local nFolha      	:= 1
Local nFolhas		:= 0
Local nMaxDes	    := 54  //MAXIMO TAMANHO DESCRIÇÃO
