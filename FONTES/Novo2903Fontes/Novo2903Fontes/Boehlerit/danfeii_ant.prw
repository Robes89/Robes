...
For nZ := 1 To nLenDet
	...
	////nMaxCod := MaxCod(oDet[nX]:_Prod:_cProd:TEXT, 90) //CUSTOMIZACAO - Jorge Heitor - MaxCod(oDet[nX]:_Prod:_cProd:TEXT, 50)
		 			...
		 			For nY := 1 To nLenSit
		 				...
		 				If Type("oImposto:_Imposto:_ICMS:_ICMS"+aSitTrib[nPrivate2])<>"U"
		 					If Type("oImposto:_IMPOSTO:_ICMS:_ICMS"+aSitTrib[nPrivate2]+":_VBCST:TEXT")<>"U"
		 						...
		 						cAux += oDet[nX]:_PROD:_CPROD:TEXT + ": BCICMS-ST R$" + AllTrim(TransForm(nBaseICM,TM(nBaseICM,TamSX3("D2_BASEICM")[1],TamSX3("D2(")[2]))) + " / "	
   		 	  				Endif
   		 	 			Endif
   					Next nY
   	   			Endif
...
oDanfe:Say(349,420,Transform(_nTotIpi-_nVSemIPI,"@ze 9,999,999,999,999.99"),oFont08:oFont) //CUSTOMIZACAO - Subtrai valor do IPI que nao deve ser impresso ref ao produtos com CSTIPI=99 de venda consignado. Tanimoto 05/03/12
