...
oReport := TReport():New("MATR260X",'Listagem de Inventário',cPerg, {|oReport| ReportPrint(oreport,aOrdem,cAliasTRB)}, " " ) //"Relacao da Posicao do Estoque"
...
TRCell():New(oSection,'B1_ENDE'		,'SB1','Endereço',/*cPictQT*/	,12,/*lPixel*/,/*{|| code-block de impressao }*/,,,"RIGHT")
