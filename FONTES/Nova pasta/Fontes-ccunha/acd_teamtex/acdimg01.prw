...
For nX := 1 to nCopias
	...
	MSCBBEGIN(1,6, )
	//MSCBBOX(50,05,76,05)
	//MSCBBOX(22,12.7,76,12.7)
	//MSCBBOX(22,21,76,21)
	//MSCBBOX(50,01,30,12.7,3)
	//MSCBGRAFIC(2,3,"SIGA")
	//MSCBSAY(25,02,'PRODUTO',"N","2","025,035")
	//MSCBSAY(43,06,"CODIGO","N","2","012,008")
	MSCBSAY(45,50, AllTrim(SB1->B1_COD), "N", "2", "032,035")
		
	//MSCBSAY(25,14,"DESC:","N","2","020,030")
	MSCBSAY(25,45,SB1->B1_DESC,"N", "2", "020,030")
	If ! Empty(cLote)
		MSCBSAY(05,18,"Lote "+cLote+'-'+cSLote, "N", "0", "020,030")
	EndIf
	MSCBSAYBAR(025,30,cCodigo,"N",cTipoBar,12.15,.F.,.T.,.F.,,2,3,.F.,.F.,"1",.T.)
