...
@description Rotina responsavel pela utilização dos pontos de entrada da rotina MATA020
...
User Function CUSTOMERVENDOR()
	...
	If ( PARAMIXB != Nil )
		...
		ElseIf ( cIdPonto == 'MODELCOMMITNTTS' )	// Após a gravação total do modelo e fora da transação
			...
			// Efetua gravacao de classe valor para fornecedores
			If ExistBlock("RCTBA01")
				U_RCTBA01(oObj, SA2->A2_COD, SA2->A2_LOJA)
			EndIf
