...
*/
User Function TEAMParcela(cGet1)
...
if empty(cGet1)
    aviso("Atenção","A data de Entrega não foi preenchida por favor preenche a data de entrega para alterar a parcela",{"Ok"})
    return()
endif
...
cGet1 := SF2->F2_XDTENT
  ...
  DEFINE MSDIALOG oDlg TITLE "Recalculo de Vencimento de Parcelas" FROM 000, 000  TO 220, 500 COLORS 0, 16777215 PIXEL
    ...
    @ 076, 024 BUTTON oButton2 	PROMPT "&Confirmar"	ACTION(,oDlg:End())  	SIZE 037, 012 OF oDlg PIXEL
