					...
					If !Empty(aXML[nX][2])
						...
						If (!Empty(cAutoriza) .Or. !Empty(cCodAutDPEC) .Or. Alltrim(aXML[nX][8])$"2,5,7") .And. !cCodRetNFE $ RetCodDene()
							If aNotas[nX][02]=="E"
								...
								//Customizado para buscar informação digitada na Nota Fiscal de Entrada
...
oDanfe:Say(nLine+447,362,Alltrim(cMarca),oFont08:oFont)
...
oDanfe:Say(nLine+447,482,Alltrim(cNumera),oFont08:oFont)
...
oDanfe:Say(MAXBOXV-550, INIBOXH+20, "NF-e", oFont10N:oFont, , , 270)
oDanfe:Say(MAXBOXV-520, INIBOXH+35, "Nº "+StrZero(Val(oIdent:_NNf:Text),9), oFont09N:oFont, , , 270)
oDanfe:Say(MAXBOXV-520, INIBOXH+45, "SÉRIE "+SubStr(oIdent:_Serie:Text,1,3), oFont09N:oFont, , , 270)
