...
cIdPZB	:= aCrSrv[2]
	...
	For _nY := 1 To Len(_aIDs)
		...
		cValfrete := OPARSE:_SOAP_ENV_ENVELOPE:_SOAP_ENV_BODY:_NS1_SALESORDERINFORESPONSE:_RESULT:_BASE_SHIPPING_AMOUNT:TEXT
		...
		aAdd(_aCab,{"C5_TPFRETE" 	,   IIF(val(cValfrete) == 0 ,'C','F') , Nil})
		aAdd(_aCab,{"C5_FRETE" 	,   val(cValfrete) , Nil})
