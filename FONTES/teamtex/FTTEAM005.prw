...
//TRYEXCEPTION
	...
	_cQry := " SELECT PR1_RECNO, PR1_CHAVE, PR1_TIPREQ, R_E_C_N_O_ AS RECNOPR1 "
...
//CATCHEXCEPTION USING oException
	...
	ConOut("FTTEAM005.PRW:LOG"+Time()+CRLF)

	U_MonitRes("000002", 2, 0, cIdPZB,'' , .F., "FTTEAM005.PRW:LOG"+Time(), "Error", '', "", .F., .F., "", .F., .F., .F.)
