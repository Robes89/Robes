...
User Function EtProTri()
	...
	If Pergunte("TRYETTEAMP",.T.)
		...
		cQuery += " LEFT JOIN " + RetsqlName("SC5") + " SC5 ON SC5.C5_FILIAL=SC2.C2_FILIAL AND SC5.C5_NUM=SC2.C2_NUM"
		cQuery += " LEFT JOIN " + RetsqlName("SA1") + " SA1 ON SA1.A1_COD = SC5.C5_CLIENTE AND SA1.A1_LOJA = SC5.C5_LOJACLI "
